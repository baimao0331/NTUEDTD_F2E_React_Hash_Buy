...
import { flip, shift, useFloating,useHover, autoUpdate} from '@floating-ui/react';
...
export default function Listitem(props) {
    ...
    return (
        <>
            ...
            {isOpen && (
                <div ref={refs.setFloating} style={floatingStyles} class="max-w-sm rounded overflow-hidden shadow-lg" {...getFloatingProps()}>
