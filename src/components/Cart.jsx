...
export default function Cart() {
    ...
    return (
        <div className='max-w-screen-xl mx-auto '>
            <ul className={`w-full rounded-lg py-3 ${cartItems.length == 0? '':'bg-stone-50'}`}>
                ...
                (
                    <>
                        ...
                        <li key={index} className="  h-25 w-full min-w-200 flex items-center pl-10 pr-6 relative mb-4">
                            ...
                            {/*數量選擇 */}
                            <div className=" inline-flex w-1/6 h-1/3 rounded-md">
