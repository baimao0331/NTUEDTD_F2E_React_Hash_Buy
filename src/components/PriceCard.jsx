    ...
    return (
        <div className=" w-4/10  p-4 bg-stone-50 shadow-lg rounded-md flex flex-col justify-between">
            ...
            <div className=" w-full">
                ...
                <p className=" text-right text-sm text-stone-600">{item.variants[selectedVariantId].price}{item.currency}</p>
                <div className=" flex justify-between items-baseline mt-8 text-lg">
                    <p>當前價格</p>
